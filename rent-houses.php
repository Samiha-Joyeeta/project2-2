...
require_once ('CreateDb12.php');
require_once ('component12.php');


// create instance of Createdb class
$database = new CreateDb("sale", "rentHouses");
...

   {
    ...
    if(isset($_SESSION['cart1'])){
        ...
        if(in_array($_POST['property_id'], $item_array_id)){
            ...
            echo "<script>window.location = 'rent-houses.php'</script>";
        }else{
...
$sql = "INSERT INTO rentlist (email, property_id, property_name, property_price, property_image,owner_name,owner_email)
VALUES ('$email', '$pid', '$pname', '$pprice', '$pimg','$oname','$oemail')";
  ...
  ?>
	...
	<div class="container">
		<div class="row">
            ...
            component($row['property_name'], $row['property_price'], $row['property_image'], $row['property_id'],$row['owner_name'],$row['owner_email']);
                }
            ?>
