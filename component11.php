...
function component($propertyname, $propertyprice, $propertyimg, $propertyid,$oname,$oemail){
    $element = "
    <div class=\"col-md-6 col-sm-6 col-xs-12\">
     ...
     <form action=\"sale-menu.php\" method=\"post\">
             ...
             <div class=\"overlay\">
                <h3> <i class=\"fa-solid fa-location-pin\"></i> $propertyname </h3>
               ...
               <button type=\"submit\" class=\"info\" name=\"add\">  Add to Wishlist <i class=\"fa-regular fa-heart\"></i> </button>
                <p> PRICE: $$propertyprice M </p>
                 ...
                 <input type='hidden' name='owner_name' value='$oname'>
                 <input type='hidden' name='owner_email' value='$oemail'>

                 <p class=\"mail\"> Name of The Owner: $oname </p>
         <p class=\"text-lowercase\"><i class=\"fa-regular fa-envelope\"></i> $oemail </p>
