    ...
    <div class="row">
        ...
        <div class="col-sm-4 box-zone">
            ...
            <h2 class="text-center text-uppercase">Buy a house</h2>
                ...
                <button type="button" class="btn btn-outline-warning"><a class="option" href="sale-menu.php">See Options</a></button>
         ...
         <div class="col-sm-4 box-zone">
            ...
            <h2 class="text-center text-uppercase">Rent a house</h2>
                <p class="text-center">We have a list of a lot of properties with an immersive experience of photos and videos.</p>
                <button type="button" class="btn btn-outline-warning"><a class="option" href="rent-houses.php">See Options</a></button>
         ...
         <div class="col-sm-4 box-zone">
            ...
            <h2 class="text-center text-uppercase">Sell a house</h2>
                <p class="text-center">We have a list of a lot of properties with an immersive experience of photos and videos.</p>
                <button type="button" class="btn btn-outline-warning">See Options</button>
